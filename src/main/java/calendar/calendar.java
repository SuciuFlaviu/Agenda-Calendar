...
public class calendar {
  ...
  public void add(int tip, String an, String luna, String zi, String ora){
    even.add(new eveniment(tip,an,luna,zi,ora));
  }
  
  public void set(int id,int tip, String an, String luna, String zi, String ora){
    even.set(new eveniment(tip,an,luna,zi,ora));
